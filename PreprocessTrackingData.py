...
class PreprocessTrackingData():
    ...
    def __init__(self, tracking, plays, players, colors, gameId, playId):
        ...
        self.colors = colors
        self.processed_data = self.join_colors()  # Process and store the data when the instance is created
    ...
    def join_plays_with_players(self):
        ...
        return play_data.merge(self.players, left_on=['nflId', 'displayName'], right_on=['nflId', 'displayName'], how='left')
    ...
    def join_colors(self):
        ...
        return play_data_with_players.merge(self.colors, left_on='club', right_on='team_abbr', how='left')
