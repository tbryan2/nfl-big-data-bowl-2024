...
# Full path of the player who made a tackle
  geom_path(data = filter(example.play, tackle == 1), 
          aes(x = (xmax-y), y = x, group = nflId), color = "yellow", size = 15) +
...
```{r}
print(n_distinct(tackler_data$nflId))
```
